...
# Ітерація 16 — 2026-06-28

## Зроблено

- Додано структурований JSON-профіль `src/data/companyProfile.json`.
- Додано телефон, бізнес-категорії, партнерську програму та формати співпраці.
- Розширено цільові аудиторії, переваги, географію та SEO-ключові слова.
- Автопарк оновлено до 7 автомобілів із місткістю пасажирів і багажу.
- Додано блоки `Ідеально підходить для`, `Типи маршрутів` і `Факти про бізнес`.
- Додаткові послуги доповнено готовими описами для каталогів і контенту.
- Існуючі маршрути, SEO-описи та інші дані збережено.
